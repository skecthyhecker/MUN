...
(function () {
  ...
  var FAQ_DATA = [
    ...
    {
      keywords: ["first time", "beginner", "no experience", "research", "never done mun", "new to mun"],
      question: "I'm a first-timer with zero MUN experience — is that okay?",
      answer: "Absolutely — you're welcome! Navdoot Parishad is built for first-timers as much as veterans. Training primers and a supportive Executive Board will help you find your voice in committee. You can research for your committee by following these steps 1. Read the Background GuideStart by reading the official background guide provided by your conference chairs.Identify key terms, the history of the issue, and the specific guiding questions the committee wants you to solve.2. Research Your CommitteeUnderstand the jurisdiction, powers, and limitations of your specific UN body.For example, the UN Security Council can pass binding resolutions and sanctions, while the General Assembly or Human Rights Council can only issue recommendations.3. Research Your Assigned CountryBuild a basic profile using reliable databases like the CIA World Factbook for geography, demographics, and economic data.Use BBC Country Profiles to understand political history and recent timelines.Apply the SPEAR acronym to find your nation's specific policy: Speeches by leaders, government Programs, hosted Events, signed Agreements (treaties/resolutions), and official Reports.4. Analyze the Topic and Past UN ActionsLook at previous UN resolutions and reports via the UN Digital Library to see what the international community has already tried.Check your country's past voting record and official statements on this exact issue.5. Map Out Allies and OpponentsCreate a simple country matrix—a chart mapping out other committee members to see who is an ally, a neutral party, or an opponent.This preparation lets you form voting blocs quickly during unmoderated caucuses."
    },
    {
